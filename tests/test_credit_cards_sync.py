...
`{vault}/99-obsidian/99-AI/external-ingest/Finanzas/Tarjetas/`, hash-skip if content
...
def test_sync_writes_one_note_per_card_cycle(isolated_finances):
    """Single xlsx → 1 .md under `99-obsidian/99-AI/external-ingest/Finanzas/Tarjetas/`."""
    import rag
    ...
    assert stats["target"] == "99-obsidian/99-AI/external-ingest/Finanzas/Tarjetas"

    target_dir = vault_root / "99-obsidian/99-AI/external-ingest/Finanzas/Tarjetas"
...
def test_sync_note_has_structured_frontmatter(isolated_finances):
    ...
    note = (vault_root / "99-obsidian/99-AI/external-ingest/Finanzas/Tarjetas/"
