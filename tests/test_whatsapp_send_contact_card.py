...
def test_tool_registered_in_chat_tools():
    # Usamos `_tools.propose_whatsapp_send_contact_card` (no `rag.propose_...`)
    # en el lado izquierdo para que ambos operandos del `in` vengan del mismo
    ...
    assert _tools.propose_whatsapp_send_contact_card in _tools.CHAT_TOOLS
