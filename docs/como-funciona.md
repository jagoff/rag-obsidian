...
```
 ...
 ──────────────────────────────────────────
   ...
   de opinión en la semana → escribe a 04-Archive/99-obsidian-system/99-AI/reviews/YYYY-WNN.md
```
...
tu-vault/                       ◀── tu vault de Obsidian
 ...
 ├── 03-Resources/
 ├── 04-Archive/
 └── 04-Archive/99-obsidian-system/99-AI/reviews/                ◀── donde caen morning/today/digest
```
