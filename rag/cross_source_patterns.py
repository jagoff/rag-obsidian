...
# ──────────────────────────────────────────────────────────────────────────
# Collectors movidos a `rag/cross_source_collectors.py` (2026-05-09).
# El import al final del módulo dispara el registro vía `@register_metric`.
...
# ──────────────────────────────────────────────────────────────────────────
# Trigger collectors registration (side-effect import).
# DEBE ir al FINAL del módulo, después de `register_metric` y todos los
# helpers que los collectors importan via lazy. Sin esto, el registry queda
# vacío y `compute_correlations()` no tiene métricas que correlar.
from rag.cross_source_collectors import *  # noqa: F401, F403, E402
