...
# ──────────────────────────────────────────────────────────────────────────
# Journal scorers (re-export)
# Movido a `rag/mood_journal.py` (2026-05-09). Re-exportado para preservar
# `from rag.mood import score_journal_recent` etc. y los monkeypatches de
# tests que aún hacen `monkeypatch.setattr(mood, "_journal_sentiment_llm", ...)`.
from rag.mood_journal import (  # noqa: F401, E402
