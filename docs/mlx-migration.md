...
> Doc técnica de referencia. PM doc + estado vivo en el vault: [`99-AI/system/mlx-migration/dispatch.md`](obsidian://open?vault=Notes&file=99-obsidian%2F99-AI%2Fsystem%2Fmlx-migration%2Fdispatch).
...
- **`qwen3-embedding:0.6b`** — embedder activo. El path de embedding usa `ollama.embed()` directamente (no el `LLMBackend` ABC). Migración separada en [`99-AI/system/embedding-swap-qwen3-8b/`](obsidian://open?vault=Notes&file=99-obsidian%2F99-AI%2Fsystem%2Fembedding-swap-qwen3-8b%2Fplan).
...
Detalle vivo en [`dispatch.md`](obsidian://open?vault=Notes&file=99-obsidian%2F99-AI%2Fsystem%2Fmlx-migration%2Fdispatch). Resumen:
...
- PM doc: [`99-AI/system/mlx-migration/dispatch.md`](obsidian://open?vault=Notes&file=99-obsidian%2F99-AI%2Fsystem%2Fmlx-migration%2Fdispatch).
- Repo CLAUDE.md: [`CLAUDE.md`](../CLAUDE.md) (sección "MLX migration").
- Embedding migration paralela: [`99-AI/system/embedding-swap-qwen3-8b/plan`](obsidian://open?vault=Notes&file=99-obsidian%2F99-AI%2Fsystem%2Fembedding-swap-qwen3-8b%2Fplan).
