...
def test_brief_state_dedup_sql_hit(sql_env):
    ...
    rag._brief_state_record("99-obsidian/99-AI/reviews/2026-04-19.md", "01-Projects/a.md")
    assert rag._brief_state_seen("99-obsidian/99-AI/reviews/2026-04-19.md",
...
def test_brief_state_dedup_sql_only(sql_env):
    ...
    key = "99-obsidian/99-AI/reviews/2026-04-18.md\x0001-Projects/legacy.md"
    rag.BRIEF_STATE_PATH.write_text(
        json.dumps({"ts": "2026-04-18T07:00:00", "key": key}) + "\n",
        encoding="utf-8",
    )
    assert rag._brief_state_seen("99-obsidian/99-AI/reviews/2026-04-18.md",
