...
def test_retry_pending_conversation_turns_sanitizes_legacy_infinity(
    ...
    (vault_root / "99-obsidian" / "99-AI" / "conversations").mkdir(parents=True)
    ...
    # Las tres notas quedan escritas en 99-obsidian/99-AI/conversations/.
    conv_folder = vault_root / "99-obsidian" / "99-AI" / "conversations"
