...
- Skipea sessions con outcome `abandon` o `partial` — son ambiguas, no
  podemos inferir reward sin riesgo de meterle ruido al ranker.
...
def apply_reward_from_session_outcomes(
    ...
    *,
    ...
    for analysis in analyses:
        if analysis.outcome in ("abandon", "partial"):
        ...
        for turn_id_int, ts, q, paths_json in turns:
            ...
            if not dry_run:
                extra = {
                    ...
                    "session_confidence": analysis.confidence,
