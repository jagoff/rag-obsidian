...
def test_no_config_is_silent_noop(cfg_set, captured):
    cfg_set(None)
    sent = rag._brief_push_to_whatsapp("Morning", "00-Inbox/reviews/x.md", "hola")
...
def test_sends_to_jid_with_title_and_path_and_body(cfg_set, captured):
    ...
    sent = rag._brief_push_to_whatsapp(
        "Morning 2026-04-15", "00-Inbox/reviews/2026-04-15.md", "Hola, hoy enfocate."
    )
    assert sent is True
    ...
    assert "00-Inbox/reviews/2026-04-15.md" in text
...
def test_logs_brief_push_event(cfg_set, captured, tmp_path):
    cfg_set("123@g.us")
    rag._brief_push_to_whatsapp(
        "Morning 2026-04-15", "00-Inbox/reviews/x.md", "hola"
    )
    ...
    assert push_events[0]["path"] == "00-Inbox/reviews/x.md"
