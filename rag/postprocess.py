...
# ══════════════════════════════════════════════════════════════════════
# Citation NLI Verifier (re-export)
# ══════════════════════════════════════════════════════════════════════
# Movido a `rag/postprocess_citation_nli.py` (2026-05-09). Re-exportado
# para preservar `from rag.postprocess import verify_answer_nli` /
# `apply_nli_mode` / `VerificationResult` y los monkeypatches de tests.
from rag.postprocess_citation_nli import (  # noqa: F401, E402
    VerificationResult,
