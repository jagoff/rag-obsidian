...
def test_ensure_telemetry_tables_idempotent(tmp_path):
    ...
    # 1 cita detections (rag_cita_detections, OCR→cita detector 2026-04-23) +
...
def test_sql_upsert_replace(conn):
    row1 = {
        ...
        "relative_path": "99-obsidian/99-AI/conversations/2026-04-19-1100-aaa.md",
        "updated_at": "2026-04-19T11:00:00",
    }
    row2 = {
        "session_id": "wa:5493425153999",  # same PK
        "relative_path": "99-obsidian/99-AI/conversations/2026-04-19-1200-bbb.md",
