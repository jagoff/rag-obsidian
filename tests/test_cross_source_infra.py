...
def test_valid_sources_contains_expected():
    # Phase 1 registered 6 sources — vault + 5 non-vault. Anchor test so
    # future additions don't silently grow the surface.
...
def test_source_weights_dict_covers_every_valid_source():
    # Hierarchy: vault > calendar > reminders > gmail > whatsapp = messages.
