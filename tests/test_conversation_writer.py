...
def test_first_turn_creates_note_with_frontmatter(tmp_vault):
    ...
    assert path.parent == tmp_vault / "04-Archive" / "99-obsidian-system" / "99-AI" / "conversations"
...
def test_turn_with_inf_confidence_sanitized_on_second_turn(tmp_vault):
    ...
    folder = tmp_vault / "04-Archive" / "99-obsidian-system" / "99-AI" / "conversations"
...
def test_malformed_frontmatter_raises(tmp_vault):
    sid = "web:broken"
    target = tmp_vault / "04-Archive" / "99-obsidian-system" / "99-AI" / "conversations" / "broken.md"
...
def test_upsert_new_session_flag_on(sql_env):
    sid = "web:t5-new"
    rel = "04-Archive/99-obsidian-system/99-AI/conversations/2026-04-19-1000-hello.md"
...
def _worker_upsert(args):
    ...
    for i in range(10):
        ...
        rel = f"04-Archive/99-obsidian-system/99-AI/conversations/{proc_id}-{i}.md"
