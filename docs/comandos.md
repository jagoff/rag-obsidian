...
### `rag morning`
Brief matutino: qué pasó ayer + qué enfocar hoy. Escribe a `04-Archive/99-obsidian-system/99-AI/reviews/YYYY-MM-DD.md`.
...
```bash
rag today                                  # escribe 04-Archive/99-obsidian-system/99-AI/reviews/YYYY-MM-DD-evening.md
rag today --dry-run
...
rag archive --report / --no-report         # reporte a 04-Archive/99-obsidian-system/99-AI/reviews/
rag archive --plain
```
