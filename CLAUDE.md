...
- `OBSIDIAN_RAG_MOZE_DIR` — override iCloud source dir for MOZE CSV exports. Default `~/Library/Mobile Documents/iCloud~amoos~Tally4/Documents` (Tally4 app container). Separated from the credit-cards/PDF dir on 2026-05-04 — antes ambas fuentes vivían en `CloudDocs/Finances`.
